#!/usr/bin/env python3
# =========================================================================
# MLX-YouTubeScribe - GUI Version
# Objective: Generate transcripts from YouTube videos using local Whisper models with MLX acceleration and a Streamlit interface
# =========================================================================
# Author: spidernic
# Created: May 2025
# =========================================================================
...
def main():
    ...
    youtube_url = st.text_input("Enter YouTube URL or Playlist URL:")

    if st.button("Generate Transcript"):
        if youtube_url:
            if is_playlist_url(youtube_url):
                st.write("Processing playlist...")
                process_playlist(youtube_url)
                st.write("Playlist processing complete! Check the output directory.")
            else:
                st.write("Analyzing video...")
                transcript, _ = analyze_youtube_video(youtube_url)
                if transcript:
